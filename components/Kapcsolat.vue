    ...
    <div class="container flex flex-col md:flex-row mx-auto">
      <div class="md:w-1/2 w-full mx-auto">
        ...
        <ul class="pt-5 md:pt-10 pl-4 pr-6 md:pl-32 md:text-lg">
          <li
            class="leading-normal text-base md:text-xl md:text-left text-center"
          >
          ...
          <li class="pt-6 md:pt-12 text-center md:text-left">
            Cím: 3412 Bogács Ipartelep 03/27 HRSZ.
          </li>
          <li class="pt-5 md:pt-10 text-center md:text-left">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              id="phone"
